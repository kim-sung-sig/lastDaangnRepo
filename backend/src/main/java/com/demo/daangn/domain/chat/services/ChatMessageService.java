package com.demo.daangn.domain.chat.services;

import java.util.UUID;

import com.demo.daangn.domain.chat.requests.message.MessageTextRequest;
import com.demo.daangn.domain.chat.requests.message.MessageWithFileRequest;
